<%@ Page Title="" Language="C#" MasterPageFile="~/student.master" AutoEventWireup="true" CodeFile="changepassword.aspx.cs" Inherits="changepassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td>
            <asp:Image ID="Image1" runat="server" ImageUrl="~/img/password_icon.png" />

        </td>
       <td>
<table style="height: 150px; width: 540px">
   <tr>
        <td>
